...
class ProductsCategoryTests(unittest.TestCase):
    ...
    def test_can_start_app(self):
        ...
        self.assertIn("AgroTim-Global - Home", self.browser.title)
    ...
    def test_user_click_product_tab(self):
        ...
        product_tab.click()
        self.assertIn(f"AgroTim-Global - Products", self.browser.title)
    ...
    def test_user_selects_category(self):
        ...
        self.assertIn(f"AgroTim-Global - {selected_category_name}", self.browser.title)
    ...
    def test_subcategory_select(self):
        ...
        self.assertIn(f"AgroTim-Global - Categories", self.browser.title)
        ...
        self.assertIn(f"AgroTim-Global - {selected_subcategory_name}", self.browser.title)
...
class ShowRoowTests(unittest.TestCase):
    ...
    def test_click_showrooms_tab(self):
        ...
        product_tab.click()
        self.assertIn(f"AgroTim-Global - Showrooms", self.browser.title)
    ...
    def test_select_showroom(self):
        ...
        self.assertIn(f"AgroTim-Global - {selected_showroom_name}", self.browser.title)
    ...
    def test_select_store(self):
        ...
        self.assertIn(f"AgroTim-Global - {selected_store_name}", self.browser.title)
